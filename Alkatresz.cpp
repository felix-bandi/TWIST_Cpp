...
void MainWindow::alk_letesz(int alk)
{
	...
	if (a.p.size() > 0)
		for (size_t i = 0; i < a.p.size(); i++)
		{
			...
			poli.pont.clear();
			for (size_t j = 0; j < a.p[i].pont.size(); j++)
			{
				D2D1_POINT_2F p;
